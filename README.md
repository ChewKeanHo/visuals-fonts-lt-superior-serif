# LyonsType's Superior Serif (`LT Superior Serif`) Font | (Holloway) Chew, Kean Ho's Creative Visuals

[![banner](/Pictures/banner_1200x630.svg)](#)

LyonsType's Superior Serif (`LT Superior Serif`) is a Latin (ID: `*Latn`) with
Cyrillic (ID: `*Cyrl`) and Greek (ID: `EL`) Serif font designed by
[The LyonsType's Superior Serif Project Team](https://lyonstype.neocities.org/fonts).
Its design is based on multi-lingual supports using standard serif presentation.
...
```
Title: LyonsType's Superior Serif (LT Superior Serif) Font
Creators: The LyonsType's Superior Serif Project Team
Packaged-By: (Holloway) Chew, Kean Ho
Contact: hello@chewkeanho.com
SKU: chewkeanho-visuals-fonts-lt-superior-serif
UUID: BC26117B-D91D-4931-B23D-D8E6AD0946E8
...
Procure: https://github.com/ChewKeanHo/visuals-fonts-lt-superior-serif
```
